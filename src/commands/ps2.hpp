...
namespace alice{
    ...
    void dump_stats(std::string name){
        ...
        // also::function_counts counts = also::node_functions(ntk);
        ...
        std::cout << std::setw( 3 ) << " "
                    ...
                    << " |" << std::setw( 4 ) << ( counts1.maj_num == 0 ? " / " : std::to_string( counts1.maj_num ) ) << " |" << std::setw( 4 ) << ( counts1.and_num == 0 ? " /" : std::to_string( counts1.and_num ) ) << " |" << std::setw( 4 ) << ( counts1.or_num == 0 ? " /" : std::to_string( counts1.or_num ) ) << " |" << std::setw( 4 ) << ( counts1.xor3_num == 0 ? " /" : std::to_string( counts1.xor3_num ) ) << " |" << std::setw( 4 ) << ( counts1.xor_num == 0 ? " /" : std::to_string( counts1.xor_num ) ) << " |" << std::setw( 4 ) << ( counts1.xnor_num == 0 ? " /" : std::to_string( counts1.xnor_num ) ) << " |" << std::setw( 7 ) << ( counts1.unknown_num == 0 ? " /" : std::to_string( counts1.unknown_num ) ) << " |" << std::setw( 7 ) << ( counts1.input_num == 0 ? " /" : std::to_string( counts1.input_num ) ) << " |" << std::endl;
        std::cout << std::setw( 3 ) << " " << std::setfill( '-' ) << std::setw( 61 ) << "" << std::setfill( ' ' ) << std::endl;
        std::cout<<"-------------------------------------------------------------------------------\n";
        std::cout << "  +Skip level : "
                  << "\n"
        ...
        std::cout << std::endl;
        std::cout<< "  +Gate in critical paths : "<<"\n";
        std::cout << std::setw( 3 ) << " " << std::setfill( '-' ) << std::setw( 61 ) << "" << std::setfill( ' ' ) << std::endl;
        std::cout << std::setw( 3 ) << " "
                  << "| " << std::left << std::setw( 4 ) << "Name"
                  << " |" << std::setw( 4 ) << "MAJ"
        ...
        dag_view.foreach_node( [&]( auto node )
                               { levels[dag_view.level( node )]++; } );
        ...
        protected:
          void execute()
          {
            ...
            // std::cout<<"You need to pass in parameters to display information, for example : ps2 -a."<<std::endl;
          }
